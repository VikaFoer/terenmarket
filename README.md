...
### ✅ Монолітний деплой - Один сервіс

Проект налаштований для **монолітного деплою** - один сервіс обслуговує і backend, і frontend!
...
5. **Railway автоматично**:
   - Встановить залежності для client та server
   - Збудує React додаток
   - Запустить backend сервер, який обслуговує frontend

6. **Перевірка**
   - Відкрийте URL вашого сервісу
   - Має відкритися сторінка логіну SmartMarket
   - Спробуйте увійти: `admin` / `admin123`

### 📚 Детальні гайди

- **Монолітний деплой (рекомендовано)**: `RAILWAY_MONOLITHIC_SETUP.md` ⭐
